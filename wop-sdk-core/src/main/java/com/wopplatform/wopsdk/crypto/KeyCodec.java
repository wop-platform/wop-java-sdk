...
public final class KeyCodec {
        ...
        try {
            ...
            if (der.length == 65 && der[0] == 0x04) {
                ECPublicKeyParameters params = new ECPublicKeyParameters(
                        com.wopplatform.wopsdk.crypto.strategies.Sm2Support.decodePoint(der), sm2Domain());
            ...
            com.wopplatform.wopsdk.crypto.strategies.Sm2Support.toPublicParams(key);
            return key;
    ...
    private static PrivateKey doParsePrivate(byte[] der, AlgorithmSuite suite) {
        try {
            ...
            if (der.length == 32) {
                ...
                com.wopplatform.wopsdk.crypto.strategies.Sm2Support.requireValidD(d);
            ...
            com.wopplatform.wopsdk.crypto.strategies.Sm2Support.toPrivateParams(key);
            return key;
        } catch (WopSdkException e) {
            throw e;
        } catch (Exception e) {
    ...
    private static ECNamedDomainParameters sm2Domain() {
        return com.wopplatform.wopsdk.crypto.strategies.Sm2Support.namedDomain();
    }
