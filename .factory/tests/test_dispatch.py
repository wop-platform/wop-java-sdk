...
class TestDispatchParsers:
    ...
    def test_extract_slug_codeup_rejected(self):
        ...
        assert extract_slug(
            ["git@codeup.aliyun.com:000000000000000000000000/gtsp/x.git"]
        ) == ""
    ...
    def test_codeup_remote_derivation(self, monkeypatch):
        ...
        cases = [
            ("https://codeup.aliyun.com/6ab/group/x.git", ("6ab", "gtsp/x")),
            ("https://codeup.aliyun.com/6ab/group/x", ("6ab", "gtsp/x")),
            ("ssh://git@codeup.aliyun.com:22/6ab/group/x.git", ("6ab", "gtsp/x")),
            ("git@codeup.aliyun.com:6ab/group/x.git", ("6ab", "gtsp/x")),
